...
# # https://www.omnicalculator.com/physics/altitude-temperature#:~:text=As%20we%20can%20see%2C%20a,*%200.00356%20%3D%20115.2%20%C2%B0F%20.
import math
...
def simulate(height):
    ...
    for i in range(0, len(XYTPts)):
        nineDrones.append(cal(XYTPts[i][0], XYTPts[i][1], XYTPts[i][2], height))
    ...
    return [nineDroneLinearError, nineDroneNearestError]
